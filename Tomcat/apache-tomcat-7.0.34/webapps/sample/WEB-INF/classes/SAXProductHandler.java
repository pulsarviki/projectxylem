...
class SAXProductsHandler extends DefaultHandler {

	// private List<Products> pData;
	...
	Products product;
	// Accessory acc;
	HashMap<String, Products> hpCatalog = new HashMap<String, Products>();
	// HashMap<String, Accessory> accessoryMap = new HashMap<String, Accessory>();


	public HashMap<String, Products> readDataFromXML(String fileName)
	...
	public void characters(char[] ch, int start, int length) throws SAXException {
			...
			// 	product.setProductsOnSale(YesNo.fromString(new String(ch, start, length)));
