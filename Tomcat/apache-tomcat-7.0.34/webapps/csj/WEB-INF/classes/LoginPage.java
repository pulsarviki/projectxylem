...
public class LoginPage extends HttpServlet {
  ...
  public void init() throws ServletException {
	...
	protected void doPost(HttpServletRequest request,
		...
		HashMap<String, User> usersDb = store.getUsers();
...
//			HttpSession session = request.getSession();
//			session.setAttribute("user", "rohan");
//			// Configure: setting session to expiry in 30 mins
//			session.setMaxInactiveInterval(30*60);
//			Cookie userName = new Cookie("user", user);
//			userName.setMaxAge(30*60);
...
//			
//		}else{
//			response.sendRedirect(response.encodeRedirectURL(request.getContextPath() + "/login?Incorrect-username-Or-password."));
//			
//		}
	}
