...
class SAXProductHandler extends DefaultHandler {
	...
	public HashMap<String, Product> readDataFromXML(String fileName)
		...
		System.out.println("readDataFromXML start");
		SAXParserFactory factory = SAXParserFactory.newInstance();
		javax.xml.parsers.SAXParser parser = factory.newSAXParser();

		parser.parse(new File(fileName), this);
		System.out.println("readDataFromXML done");
		return hpCatalog;
	}
	...
	public void endElement(String uri, String localName, String qName) throws SAXException {
		if (qName.equalsIgnoreCase("product")) {
			...
			accessoryMap = new HashMap<String, Accessory>();
			bproduct = false;


		}
		if (qName.equalsIgnoreCase("accessory")) {
			System.out.println("END of acc "+acc.getName()+acc.getDiscount());
